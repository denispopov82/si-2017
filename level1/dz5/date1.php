 ...
 * Найдите количество минут, часов и дней, содержащихся в $sec (не одновременно,
 * а последовательно: сначала минуты, потом часы и т.д.).
 */
$last = mktime(7, 23, 48, 3, 17, 2017);
$now = time();
$sec = ($now - $last);
echo 'Seconds: ' . $sec;
echo '<br>';
echo 'Minutes: ' . intval($sec / 60);
echo '<br>';
echo 'Hours: ' . intval($sec / 3600);
echo '<br>';
echo '<br>';
...
// 8. С помощью функций mktime и date выведите 13 февраля 2015 года в формате '31.02.2015'.
 ...
 * Узнайте какой день недели был 21.12.1982, в ваш день рождения.
 */
...
$months = [];
for ($i = 1; $i < 13; $i++) {
    $timestamp = mktime(0, 0, 0, $i, 1, 2017);
